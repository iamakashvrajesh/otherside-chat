    ...
    <>
        ...
        <div className="ticker-container">
          ...
          <div className="ticker-rotating">
            {tickerQuestions.map((q, i) => (
              ...
              >
                <span className={`ticker-gtag ${q.gender}`}>
                  {q.gender === 'girl' ? 'Girl' : 'Guy'}
                </span>
      ...
      <section className="threads-section">
        ...
        <div className="threads-list">
          {[
            {
              gender: 'girl', time: '2h ago', topic: 'Texting',
              q: "When a guy says \"I'll let you know\" about plans — be honest, is that just a polite no?",
              answers: 47, splitGirls: 30, splitGuys: 64, splitNb: 6,
              reply: { gender: 'guy', handle: '@northbound', text: "Honestly? 80% of the time it's a soft no. The other 20% he genuinely forgot. If you want a real answer, propose a specific time. \"I'll let you know\" dies the second it meets a Tuesday at 7." },
            },
            {
              gender: 'guy', time: '5h ago', topic: 'Crushes',
              q: "Girls — when you call a guy \"sweet\", is that ever code for \"no chemistry\"? I need to know.",
              answers: 93, splitGirls: 73, splitGuys: 22, splitNb: 5,
              reply: { gender: 'girl', handle: '@junebug', text: "Sweet alone? Mixed signal. Sweet + something specific? You're winning. Sweet by itself, said softly, with a small smile she doesn't quite commit to? Brace yourself." },
            },
            {
              gender: 'girl', time: '11h ago', topic: 'Ghosting',
              q: "Do guys actually know they're ghosting in the moment, or does it happen by default?",
              answers: 142, splitGirls: 38, splitGuys: 55, splitNb: 7,
              reply: { gender: 'guy', handle: '@mariner', text: "Almost always the second one. Day 1 you're \"just busy.\" Day 3 you're embarrassed. Day 5 you've talked yourself into believing she didn't really like you anyway. By day 7 you're just a guy who didn't text back." },
            },
          ].map((p, i) => (
      ...
      <section className="how-section">
        ...
        <div className="how-grid">
          {[
            { step: '01', color: 'pk', title: 'Ask', desc: "Post anonymously. Pick a topic. Your gender shows, your identity never does." },
            { step: '02', color: 'vi', title: 'Get answered', desc: "The other side replies. See the gender split, read perspectives you couldn't get from your friends." },
            { step: '03', color: 'bl', title: 'Go deeper', desc: "Join a live room. Pull someone aside for a 1-on-1. Or just read until something clicks." },
          ].map((step) => (
      ...
      <section className="cta-section">
        <div className="cta-card">
          <div className="cta-eyebrow">Free · always anonymous · {onlineCount.toLocaleString()} here right now</div>
